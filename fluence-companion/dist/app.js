...
app.post('/gather_kubos', async (req, res) => {
    res.send(await fluence.gatherKubos());
});

app.post('go_and_fetch', async (req,res)  => {

    res.send(await fluence.goAndFetch());
});


app.post('/render', async (req, res) => {
    try {
        res.send(await fluence.renderOnDSG(req.body));
    }
    catch (err) {
        res.json(err);
    }
...
app.post('/bulk_upload', async (req, res) => {
    try {
        res.send(await fluence.bulkUpload(req.body));
    }
    catch (err) {
        res.json(err);
    }
...
app.post('/bulk_render', async (req, res) => {
    try {
        res.send(await fluence.bulkRender(req.body));
    }
    catch (err) {
        res.json(err);
    }
