...
import { v5_callFunction as callFunction$$ } from '@fluencelabs/js-client';
// Functions
...
`;
export function bulkUpload(...args) {
    return callFunction$$(args, {
...
`;
export function gatherKubos(...args) {
    return callFunction$$(args, {
...
`;
export function renderOnDSG(...args) {
    return callFunction$$(args, {
...
`;
export function bulkRender(...args) {
    return callFunction$$(args, {
